      ...
      batch.map(f =>
        prisma.teamGameAdj.upsert({
          ...
          update: {
            ...
            offAdjHavocFront7: f.offAdjHavocFront7,
            offAdjHavocDb: f.offAdjHavocDb,
            defAdjEpa: f.defAdjEpa,
            defAdjSr: f.defAdjSr,
            defAdjExplosiveness: f.defAdjExplosiveness,
            defAdjPpa: f.defAdjPpa,
            defAdjHavoc: f.defAdjHavoc,
            defAdjHavocFront7: f.defAdjHavocFront7,
            defAdjHavocDb: f.defAdjHavocDb,
            edgeEpa: f.edgeEpa,
            edgeSr: f.edgeSr,
            edgeExplosiveness: f.edgeExplosiveness,
            edgePpa: f.edgePpa,
            edgeHavoc: f.edgeHavoc,
            edgeHavocFront7: f.edgeHavocFront7,
            edgeHavocDb: f.edgeHavocDb,
