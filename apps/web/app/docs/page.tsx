              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">Week 10 Ingestion</h3>
                      <p className="text-sm text-gray-600">
                        Verification guide for Week 10 odds ingestion fix
                      </p>
                    </div>
                  </div>
                </Link>
                ...
                <Link
                  href="/docs/2026-betting-playbook"
                  className="block h-full bg-white rounded-lg shadow hover:shadow-md transition-all p-6 border border-gray-200"
                >
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">2026 Betting Playbook</h3>
                      <p className="text-sm text-gray-600">
                        How Hybrid V2, conflict tags, and Fade V4 drive the 2026 spread strategy
                      </p>
                    </div>
                  </div>
                </Link>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">Bowl & Postseason Ops</h3>
                      <p className="text-sm text-gray-600">
                        Step-by-step checklist for running bowl weeks, CFP games, and postseason ingest
                      </p>
                    </div>
                  </div>
                </Link>
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">Data Inventory & Feature Map</h3>
                      <p className="text-sm text-gray-600">
                        What we store for each team and season, where it comes from, and which models use it
                      </p>
                    </div>
                  </div>
                </Link>
