/**
 * Game Detail Page Skeleton Loader
 * 
 * Displays a skeleton placeholder matching the game detail page layout
 */
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Betting Lines Summary Skeleton */}
