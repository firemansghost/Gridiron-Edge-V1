...
export class OddsApiAdapter implements DataSourceAdapter {
   ...
   */
  private async fetchLiveOdds(season: number, week: number): Promise<any[]> {
    const lines: any[] = [];
   ...
   */
  private async fetchHistoricalOdds(season: number, week: number, startDate: string, endDate?: string): Promise<any[]> {
